...
namespace helper
{
   public class Tablet_Accessories
    {
        Database db = new Database();
        Common_Use common = new Common_Use();
        int Brand = 1, Model = 2, Type = 3, Size = 4, TabletModel = 5, Colors = 6, Material = 7,
        ...
        private void setupTable()
        {
            ...
            Form1.OrganizedSheet.Invoke(new Action(() => Form1.OrganizedSheet.Columns.Add("Size", "Size without inch")));
            Form1.OrganizedSheet.Invoke(new Action(() => Form1.OrganizedSheet.Columns.Add("tablet", "Tablet Model")));
        ...
        public void createBulk()
        {
            ...
            Form1.BulkSheet.Invoke(new Action(() => Form1.BulkSheet.Columns.Add("Size", "Screen Size")));
        ...
        private void setTitle(int row)
        {
            ...
            title = title + Form1.OrganizedSheet[Type, row].Value + " for " + Form1.OrganizedSheet[TabletModel, row].Value + " " +
        ...
        private void setDescription(int row)
        {
            ...
            if (Form1.OrganizedSheet[Brand, row].Value.ToString().ToLower().Trim() != "other")
            {
                ...
                arBrand= "<ul><li>العلامه التجارية: " + db.getRecord(Form1.OrganizedSheet[Brand, row].Value.ToString())+ "</li>";
            }



            Form1.BulkSheet[2, row].Value = brand + "<li>Mobile Accessory Type: " +
                Form1.OrganizedSheet[Type, row].Value + "</li><li>Compatible with: "  +
                Form1.OrganizedSheet[TabletModel, row].Value + "</li><li>Color: " + Form1.OrganizedSheet[Colors, row].Value +
        ...
        private void setScreenSize(int row)
        {
            Form1.BulkSheet[4, row].Value = Form1.OrganizedSheet[Size, row].Value + " Inch";
            Form1.BulkSheet[12, row].Value = Form1.OrganizedSheet[Size, row].Value + " انش";

        }
    
        private void setDevice(int row)
        {
            Form1.BulkSheet[5, row].Value = Form1.OrganizedSheet[TabletModel, row].Value;
            Form1.BulkSheet[13, row].Value = db.getRecord(Form1.OrganizedSheet[TabletModel, row].Value.ToString());
        ...
        {
            Form1.BulkSheet[6, row].Value = getTypeAttribute(Form1.OrganizedSheet[Type, row]);
