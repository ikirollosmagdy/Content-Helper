 ...
 public   class Underwears
    {
        ...
        private void setupTable()
        {
            ...
            StyleColumn.HeaderText = "Underwear Type";
            StyleColumn.DisplayStyle = DataGridViewComboBoxDisplayStyle.ComboBox;
            StyleColumn.FlatStyle = FlatStyle.Popup;
            StyleColumn.Items.AddRange("Boxer", "Brief", "Camisole", "Girls Bra", "Men Shapewear", "Panty", "Tank", "Thermal Underwear", "Under Pant", "Under Shirt", "Under Short", "Underwear Set");
        ...
        {
            Form1.BulkSheet[5, row].Value = getCatBulk(Form1.OrganizedSheet[Style, row].Value.ToString().Trim());
