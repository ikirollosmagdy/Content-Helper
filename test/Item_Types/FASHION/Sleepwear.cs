...
namespace helper
{
    public class Sleepwear
    {
        ...
        private void setupTable()
        {
            ...
            TypeColumn.HeaderText = "Sleepwear Style";
            TypeColumn.DisplayStyle = DataGridViewComboBoxDisplayStyle.ComboBox;
            TypeColumn.FlatStyle = FlatStyle.Popup;
            TypeColumn.Items.AddRange("Eyes Mask", "Loungewear Set", "Nightgown", "Nightshirt", "Pajama Bottom", "Pajama Short", "Pajama Top", "Pajama", "Robe", "Sleepwear Set");
        ...
        public void createBulk()
        {
            ...
            Form1.BulkSheet.Invoke(new Action(() => Form1.BulkSheet.Columns.Add("type", "Sleepwear Type")));
            ...
            Form1.BulkSheet.Invoke(new Action(() => Form1.BulkSheet.Columns.Add("Artype", "Sleepwear Type Arabic")));
        ...
        private void setDescription(int row)
        {
            ...
            Form1.BulkSheet[10, row].Value = string.Format("<p><b>خصائص المنتج:</b></p><ul><li>العلامة  التجارية:{0}</li><li>رقم الموديلr:{1}</li><li>اللون:{2}</li><li>المقاس:{3}</li><li>الخامة:{4}</li><li>المجموعة المستهدفة:{5}</li></ul>",
